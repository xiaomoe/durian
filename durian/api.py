...
from durian.typing import ErrorCallable, ReturnValue, RouteCallable, RouteMethod
...
class API:
    ...
    exception_handler: dict[int | None, dict[type[Exception], ErrorCallable]] = defaultdict(dict)
    ...
    def add_route(
        ...
        assert endpoint not in self.view_funcs, "route already exists."  # noqa
    ...
    def parse_request(self, environ: "WSGIEnvironment") -> None:
        """Change environ (dict) to Response (class) as well as change the request to global variable."""
